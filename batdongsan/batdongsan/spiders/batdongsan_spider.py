...
class BatdongsanSpiderSpider(scrapy.Spider):
    ...
    start_urls = [
        'https://alonhadat.com.vn/nha-dat/can-ban/nha-dat/ha-noi/430/huyen-thach-that/trang--18.html',
    ...
    def parse(self, response):
        ...
        for each in all_items:
            ...
            next_page = 'https://alonhadat.com.vn/nha-dat/can-ban/nha-dat/ha-noi/430/huyen-thach-that/trang--' + str(BatdongsanSpiderSpider.page_number) +'.html'
            if BatdongsanSpiderSpider.page_number <= 26:
